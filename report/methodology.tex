\section{Methodology}
\subsection{Strategy}
It's easy to notice that that the nested $i$ and $j$ for-loops in \textbf{Algorithm \ref*{alg:fw1}} might be parallizable, but one of the \emph{intermediate edges} for a process
